...
description: When motivation disappears, what emerges from the ashes?
tags:
  - management
  - reflection
title: Two Clicks
...
- The second case, if on top of that you think you're amazing because now you "solve problems", you might miss that someone with experience solving the problem you're solving can give you a hand or think together about the problem and possible solutions, because you argue based on a solution an LLM gave you, nothing really; good luck.
- If you don't have prior experience in what you're trying to solve, what you send to production is a coin flip because when something fails you won't know what to do other than ask an agent how to solve the problem, not even that; maybe you can't even troubleshoot and the amount of time you invest in it, I'd like to calculate it to understand how fast you're really going.

Lastly, there's something that worries me and on the other hand reassures me, which is that models are feeding on solutions that don't work and since they're taken as good because people without experience mark them as such, they'll continue to spread until at some point everything explodes; does it reassure me that everything explodes? ugh no, what a drag to have to explain, no, I don't want everything to explode, what I mean is that I'll continue learning from the best, deepening the knowledge I'm acquiring and the day something explodes, I'll have the tools to at least sit down and see what's happening without needing an AI, just with the value of previous experiences and [the beautiful challenge; the pleasure of having an unsolved problem in your head](https://youtu.be/ARXdEMbPTGs?si=xj8I1pR_d0JcyerZ).

Ultimately they're going to want to finish off your brain in bites, but don't let them drink the juice from your heart.

---

> _And a heart doesn't harden just because_,
>
>       La hija del fletero, Indio Solari, Patricio rey y sus redonditos de ricota.

To wrap up, I want to reflect a bit on the anxiety we live in and how AI will exacerbate this phenomenon; if with social media this anxiety issue had already deepened, with AI it's like taking 50 grams of crystal in one shot.

Be fair, be honest, if it's within your reach, help with the professional and personal development of the people around you, walk with humility because beyond any solution you've made, what's important (at least for me) is that former and current coworkers remember you and choose you to share a drink and/or catch up on life.

Don't be surprised --recapping the entire post-- if you see someone who is discouraged only looking for the answer in that discouraged person, maybe you have to stop the ball and honestly ask yourself what led that person to have their heart harden, did I perhaps contribute something to make them feel that way?

---

To finish, if they want you to make two clicks, make two clicks and that's it; nothing personal is at stake there and at least you know how the game board is set up, that if they want to finish off your brain in bites, don't let them drink the juice from your heart, and that a heart doesn't harden just because, and if that happens.

> _More than once I've heard myself say_
>
> _**that in resistance lies**_
>
> _all the noble value of life_
